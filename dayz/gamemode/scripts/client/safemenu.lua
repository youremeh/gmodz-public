function ShopMenu()
    ...
    DFrame_ShopMenu.Paint = function()
        ...
        draw.DrawText(_U('safeZoneShop'), "DebugFixedLarge", 10, 10, Color(255, 255, 255, 255), TEXT_ALIGN_LEFT)
    end
    ...
    DPropSheet_Shop:AddSheet(_U('sheetWeapons'), DPanel_Weapon_Tab, "gui/silkicons/world", true, true, _U('sheetWeaponsDesc'))
    DPropSheet_Shop:AddSheet(_U('sheetAmmo'), DPanel_Equipment_Tab, "gui/silkicons/find", true, true, _U('sheetAmmoDesc'))
    DPropSheet_Shop:AddSheet(_U('sheetSurvivalGear'), DPanel_Survival_Tab, "gui/silkicons/cart", true, true, _U('sheetSurvivalGearDesc'))
    DPropSheet_Shop:AddSheet(_U('sheetCraftingMats'), DPanel_Ammo_Tab, "gui/silkicons/bullet_black", true, true, _U('sheetCraftingMatsDesc'))
    DPropSheet_Shop:AddSheet(_U('sheetCharPerks'), DPanel_Perk_Tab, "gui/silkicons/award_star_gold_1", true, true, _U('sheetCharPerksDesc'))
    DPropSheet_Shop:AddSheet(_U('sheetSell'), DPanel_Sell_Tab, "icon16/money.png", true, true, _U('sheetSellDesc'))
    ...
    updateSell()
    local DButton_Donate = createButton(DFrame_ShopMenu, 400, 4, 250, 30, _U('donationInfo'))
    ...
    for ItemID, quantity in pairs(Client_Inventory) do
        if quantity > 0 and DayZItems[ItemID] and DayZItems[ItemID].CanBeSold and DayZItems[ItemID].Price and DayZItems[ItemID].Price > 0 then
            ...
            dModelPanel_Item.DoClick = function()
                ...
                D_ItemMENU:AddOption(_U('sheetSell'), function()
...
function donateMenuSafe()
    ...
    DonatePanel:Center()
    DonatePanel:SetTitle(_U('donationInfo'))
    ...
    DLabel_Info:SetText(_U('donationBenefits'))
    ...
    DLabel_BenefitInfo:SetText(_U('donationBenefit'))
    ...
    DLabel_Information:SetText(_U('donationInformation'))
    ...
    DLabel_BenefitContent:SetText(_U('donationInfo'))
