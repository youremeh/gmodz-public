function shopItems(frame, shoptype)
    for _, item in pairs(DayZShop[shoptype]) do
        ...
        DLabel_ItemPriceLabel:SetText(_U('shopPrices'))
        ...
        if DayZItems[item].Price ~= nil then
            ...
            DLabel_ItemPriceCash:SetText(_U('moneySign')..DayZItems[item].Price)
            DLabel_ItemPriceCash:SizeToContents()
            DLabel_ItemPriceCash:SetParent(Shop_Item)
            DLabel_ItemPriceCash:SetPos(125, 80)
            local DButton_BuyCash = createButton(Shop_Item, 555, 25, 150, 30, _U('shopCash').._U('moneySign'))
        ...
        if DayZItems[item].Credits ~= nil then
            ...
            local DButton_BuyCredits = createButton(Shop_Item, 555, 60, 150, 30, _U('shopCredits').._U('credits2'))
